...
local function GetOverlay()
  ...
  if not overlay then
    ...
    overlay.bg:SetTexture("Interface\\AddOns\\ConsumesManager\\Textures\\IconAlert")
    ...
    overlay.glow:SetTexture("Interface\\AddOns\\ConsumesManager\\Textures\\IconAlertAnts")
